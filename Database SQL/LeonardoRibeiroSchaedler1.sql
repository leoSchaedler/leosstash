...
insert into tbConsulta values ('2019-04-13 13:50:00', '1', '123456', '12');
insert into tbConsulta values ('2019-06-11 13:00:00', '5', '123456', '12');
insert into tbConsulta values ('2019-07-13 16:50:00', '4', '234567', '23');
insert into tbConsulta values ('2019-01-13 18:00:00', '2', '234567', '23');
insert into tbConsulta values ('2019-11-29 10:00:00', '3', '123456', '12');
insert into tbConsulta values ('2019-11-09 11:00:00', '666', '345678', '34');
...
insert into tbConsultaExames values ('001001', '1', '234567', '23', '2019-04-13 13:50:00');
insert into tbConsultaExames values ('070001', '2', '234567', '23', '2019-06-11 13:00:00');
insert into tbConsultaExames values ('001001', '3', '345678', '34', '2019-07-13 16:50:00');
insert into tbConsultaExames values ('001001', '5', '234567', '23', '2019-11-29 10:00:00');
insert into tbConsultaExames values ('001001', '666', '345678', '34', '2019-11-09 11:00:00');

SELECT tbConvenio.convenio, tbMedico.nome
FROM tbMedico
LEFT JOIN tbConvenio
ON tbConvenio.CRM = tbMedico.CRM and tbConvenio.convenio = ('Unimed' or 'Amil');

SELECT *
FROM tbConsultaExames
WHERE date(dataHora) = '2019-11-29';

SELECT COUNT(tbEspecializacaoMedico.CRM)
FROM tbEspecializacaoMedico
LEFT JOIN tbEspecializacao
ON tbEspecializacaoMedico.codEspecialidade = tbEspecializacao.codEspecialidade
GROUP BY tbEspecializacao.descEspecialidade;

SELECT MAX(tbExames.descricaoExame)
FROM tbExames
LEFT JOIN tbConsultaExames
ON tbExames.codigoExame = tbConsultaExames.codigoExame;

SELECT tbMedico.nome, COUNT(tbConsultaExames.dataHora)
FROM tbMedico
LEFT JOIN tbConsultaExames
ON tbMedico.CRM = tbConsultaExames.CRM
WHERE year(tbConsultaExames.dataHora) = 2019
GROUP BY tbMedico.nome;

SELECT tbMedico.nome
FROM tbMedico
LEFT JOIN tbConsulta
ON tbMedico.CRM = tbConsulta.CRM
WHERE year(tbConsulta.dataHora) != 2020 
	or (year(tbConsulta.dataHora) = 2020 
	AND month(tbConsulta.dataHora) != 05)
GROUP BY tbMedico.nome;

SELECT tbConvenio.Convenio
FROM tbConvenio
LEFT JOIN tbConsulta
ON tbConvenio.CRM = tbConsulta.CRM
WHERE year(tbConsulta.dataHora) != 2019