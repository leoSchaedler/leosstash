...
create table tbCliente
	(PRIMARY KEY(email), email varchar(20), 
	nome varchar(15), 
	estado varchar(12), 
    cidade varchar(12), 
    CEP char(8), 
...
create table tbServico
	(PRIMARY KEY(codigo), codigo int, 
    tipo varchar(15),
	descricaoDoServico varchar(50), 
    valor int);
...
insert into tbHospedagemCheckIn values (11, 'shioued@email.com', 01, 'Turismo', '2020-02-06', 11.00, '2020-02-09', 10.00);
insert into tbHospedagemCheckIn values (12, 'jtsirouj@email.com', 02, 'Turismo','2020-02-02', 10.00, '2020-06-03', 10.00);
insert into tbHospedagemCheckIn values (13, 'esdrihj@email.com', 03, 'Turismo', '2020-07-01', 10.00, '2020-08-01', 12.00);
insert into tbHospedagemCheckIn values (14, 'RSTARG@email.com', 04, 'Trabalho','2020-04-04', 11.00, '2020-04-06', 12.00);
insert into tbHospedagemCheckIn values (15, 'diceo@email.com', 05, 'Trabalho','2019-07-02', 11.00, '2020-07-03', 11.00);
insert into tbHospedagemCheckIn values (16, 'postal2@email.com', 06, 'Trabalho','2019-06-06', 12.00, '2019-09-01', 13.00);
...
SELECT COUNT(email), motivo
FROM tbHospedagemCheckIn
GROUP BY motivo;

SELECT COUNT(tbCliente.email), tbCliente.estado, tbHospedagemCheckIn.motivo
FROM tbHospedagemCheckIn, tbCliente
WHERE tbCliente.email = tbHospedagemCheckIn.email
GROUP BY tbCliente.estado, tbHospedagemCheckIn.motivo;

SELECT tbServico.codigo, SUM(tbServico.valor)
FROM tbHospedagemCheckIn, tbServico, tbConsumo
WHERE tbConsumo.codigoDeReserva = tbHospedagemCheckIn.codigoDeReserva and tbServico.codigo = tbConsumo.codigo
GROUP BY codigo;

SELECT SUM(tbServico.valor) as Valor, tbHospedagemCheckIn.motivo, tbServico.codigo
FROM tbHospedagemCheckIn, tbServico, tbConsumo
WHERE tbConsumo.codigoDeReserva = tbHospedagemCheckIn.codigoDeReserva and tbServico.codigo = tbConsumo.codigo
GROUP BY tbHospedagemCheckIn.motivo, tbServico.codigo;
