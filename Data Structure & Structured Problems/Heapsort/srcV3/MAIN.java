...
public class MAIN {
    ...
    public static void main(String[] args) {
       ...
       // System.out.printf("%d números aleatorios gerados\n\n\n", TAMANHO);
        ...
        iterativeQsort(arrayDesordenadoQuickSort);
        ...
        iterativeQsort(arrayParcialmenteOrdenadoQuickSort);
        ...
        iterativeQsort(arrayOrdenadoDecQuickSort);
        ...
        mergeSort(arrayDesordenadoMergeSort);
        ...
        mergeSort(arrayParcialmenteOrdenadoMergeSort);
        ...
        mergeSort(arrayOrdenadoDecMergeSort);
    ...
    public static void iterativeQsort(Integer[] numbers) {
