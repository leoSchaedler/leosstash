...
void clearPlayArea()
{
  ligaLed(0, -2); ligaLed(0, -1);
  ligaLed(1, -2); ligaLed(1, -1);
  ligaLed(2, -2); ligaLed(2, -1);
  ligaLed(3, -2); ligaLed(3, -1);
  ligaLed(4, -2); ligaLed(4, -1);
  ligaLed(5, -2); ligaLed(5, -1);
  ligaLed(6, -2); ligaLed(6, -1);
  ligaLed(7, -2); ligaLed(7, -1);
  ligaLed(8, -2); ligaLed(8, -1);
  ligaLed(9, -2); ligaLed(9, -1);
  ligaLed(10, -2); ligaLed(10, -1);
  ligaLed(11, -2); ligaLed(11, -1);
