...
public class Fabrica extends Thread{
    ...
    private void getSleep(String c){ //TODO: Verifica em ProductionTime quanto tempo a thread precisa dormir
        int i ,j;
    ...
    public void run() {
        try {
            while (contSimultaneo < simultaneoMax){
                Fabricar Fe = new Fabricar(this.Id, this.contSimultaneo, this.simultaneoMax,this.mutex,
