...
public class NumberofTransactionsPerYeas {
...
//        Path inputB = new Path(files[1]);
        ...
        // registro de classes
        j.setJarByClass(NumberofTransactionsPerYeas.class);
        j.setMapperClass(NumberofTransactionsPerYeas.TDEMapper.class);
        j.setReducerClass(NumberofTransactionsPerYeas.TDEReducer.class);
    ...
    public static class TDEMapper extends Mapper<Object, Text, Text, IntWritable> {
        public void map(Object key, Text value, Context context) throws IOException,
            ...
            if (!value.toString().contains("country_or_area")) {
                ...
                context.write(new Text(year), cont);
            }
        }
    }
